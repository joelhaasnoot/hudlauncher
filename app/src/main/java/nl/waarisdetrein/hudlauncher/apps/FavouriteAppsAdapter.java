 ...
 */
public class FavouriteAppsAdapter extends RecyclerView.Adapter<FavouriteAppsAdapter.ViewHolder> {

    private final Context ctx;
    private ArrayList<AppModel> mApps = new ArrayList<>();

    public FavouriteAppsAdapter(Context ctx) {
        this.ctx = ctx;
    }

    @Override
    public FavouriteAppsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(FavouriteAppsAdapter.ViewHolder holder, int position) {
